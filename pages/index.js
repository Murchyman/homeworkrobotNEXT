      ...
      <div className={styles.subContainer}>
        <div className={styles.left}>
          ...
          <div className={styles.buttonContainer}>
            <Link href='/Generator'><Button className="navbar-brand" style={{ minWidth: '17em', minHeight: '4em' }} variant="contained">Get Started</Button></Link>
            <Link href='/About'><Button className="navbar-brand" style={{ minWidth: '17em', minHeight: '4em' }} variant="outlined">Learn More</Button></Link>
